...
public enum AFKParticle {
    ...
    DRIPPING_DRIPSTONE_LAVA(Particle.DRIPPING_DRIPSTONE_LAVA, 30, 1, 1L, 0.5D, 0.1D, 0.5D, 2.5D),
    DRIPPING_DRIPSTONE_WATER(Particle.DRIPPING_DRIPSTONE_WATER, 20, 1, 1L, 0.5D, 0.2D, 0.5D, 2.5D),
    ELECTRIC_SPARK(Particle.ELECTRIC_SPARK, 5, 0.01, 1L, 0.3D, 0.1D, 0.3D, 1.9D),
    FALLING_DRIPSTONE_LAVA(Particle.FALLING_DRIPSTONE_LAVA, 5, 1, 1L, 0.1D, 0.01D, 0.1D, 2.5D),
    FALLING_DRIPSTONE_WATER(Particle.FALLING_DRIPSTONE_WATER, 8, 1, 1L, 1D, 1D, 1D, 2.5D),
    FALLING_SPORE_BLOSSOM(Particle.FALLING_SPORE_BLOSSOM, 5, 1, 1L, 1D, 1D, 1D, 2.5D),
    GLOW(Particle.GLOW, 5, 0.01, 1L, 0.7D, 1D, 0.7D, 1D),
    GLOW_SQUID_INK(Particle.GLOW_SQUID_INK, 1, 0.01, 1L, 0.7D, 1D, 0.7D, 1D),
    SCRAPE(Particle.SCRAPE, 1, 0.01, 1L, 1D, 1D, 1D, 1D),
    SMALL_FLAME(Particle.SMALL_FLAME, 3, 0.02, 1L, 1D, 1D, 1D, 1D),
    SPORE_BLOSSOM_AIR(Particle.SPORE_BLOSSOM_AIR, 3, 0.02, 1L, 0.2D, 0.2D, 0.2D, 1.7D),
    WAX_OFF(Particle.WAX_OFF, 1, 0.02, 1L, 1D, 1D, 1D, 1.7D),
    WAX_ON(Particle.WAX_ON, 1, 0.1, 1L, 0.5D, 1D, 0.5D, 1.7D),
